...
def ingest_additional_programs():
    ...
    if not os.path.exists(path_to_dataset):
        ...
        print(f"{path_to_dataset} - Not Found")
        return
    ...
    '''
    Column D and E are going to be used to populate the agency_id of the program
    table. User the sub-agency id if there is a value in column E, otherwise use column D.
    Map the name of the subagency and agency to the name in the agency table and
    extract the id and use that for agency_id.

    Column F, G, and H are going to be used to populate the category and
    program_to_category tables.

    The id of the category/subcategory object in the category table is going to be 
    ...
    '''
    The program_to_category table is generated by using the id of each program, and
    mapping it to the id to each sub_category it is associated with. the category_type
    of program_to_category is going to be column H fo the csv file.
    '''
