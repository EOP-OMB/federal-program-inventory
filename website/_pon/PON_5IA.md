...
definition: 'A program whose beneficiaries attained one or more of the following results
  within the past year: -Collaborated with regional partners on shared security goals;
  -Improved capacity to manage conflict, crisis, and humanitarian challenges; -Demonstrated
  progress toward political, social, and economic stability; -Enhanced support for
  sustainable peace and reduced regional volatility.'
