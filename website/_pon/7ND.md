...
definition: 'A beneficiary demonstrated one or more of the following results within
  the past year: -Conducted unit-level exercises or simulations to validate readiness
  for joint or strategic defense missions; -Met operational benchmarks in force structure,
  equipment readiness, and logistical support for rapid deployment; -Demonstrated
  coordinated capability to execute assigned missions in domestic or international
  security contexts.'
