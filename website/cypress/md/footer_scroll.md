---
layout: default
title: Test - Footer with Return to Top
permalink: /test-footer-scroll.html
---

# Footer with Return to Top Link

This page demonstrates the footer with the "Return to top" link visible when scrolled to the bottom of the page.

## Content

- Footer navigation with "Return to top" link
- "About the FPI" link
- Footer banner
...
- The "Return to top" link becomes visible in the footer
- The link maintains its color (#1b1b1b) both on initial view and after being visited
- Clicking the link scrolls the page back to the top
